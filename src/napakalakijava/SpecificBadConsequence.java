...
public class SpecificBadConsequence extends BadConsequence{
    ...
    public boolean isEmpty(){
        return (specificHiddenTreasures.isEmpty() && specificVisibleTreasures.isEmpty()) || (this == null);
    }
    ...
    public BadConsequence adjustToFitTreasureLists(ArrayList<Treasure> v, ArrayList<Treasure> h){
        ...
        nuevaBadConsequence = new SpecificBadConsequence(super.getText(), super.getLevels(), nuevoSpecificVisible, nuevoSpecificHidden);
